...
$ grep '0\.8*' filename_plink.ld > filename_InLD.txt

$ awk '{print $8}' < filename_InLD.txt > filename_InLDlist.txt

$ sort -u filename_InLDlist.txt > filename.probesInLDlist.txt
